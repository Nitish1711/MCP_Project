...
@mcp.tool(
    ...
    description="Reads the contents of a document and returns it as STRING.",
)
...
@mcp.tool(
    ...
    description="Edits the contents of a document by replacing a string in the document content with a new string.",
)
